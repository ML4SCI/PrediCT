...
AGATSTON_SCRIPT_PATH = Path(r"E:\MyProjects\Gsoc_2026_Official\Agatston_Script\agatston_script.py")
...
_PREDICTIONS_ROOT = Path(
    r"E:\MyProjects\Gsoc_2026_Official\test_nnunet_2\nnUNet_predictions"
)
...
def _print_eval(result: dict) -> None:
    ...
    print(
        ...
        f"  PQ Score   : {p['macro_dice'] * v['dice']:.4f}  "
    )
    print(
...
if __name__ == "__main__":
    ...
    if results:
        ...
        VISUAL_OUT_DIR = Path(r"E:\MyProjects\Gsoc_2026_Official\test_nnunet_2\Visualizations")
        ...
        print(f"\n PQ Score is best for clinical evalutation which is prodcut of Recognition Quality (Plaque wise F1) and Segmentation Quality (Voxel wise Dice)")
